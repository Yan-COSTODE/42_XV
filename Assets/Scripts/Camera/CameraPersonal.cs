...
public class CameraPersonal : MonoBehaviour
{
    ...
    {
        Vector3 _forward = Vector3.ProjectOnPlane(transform.forward, Vector3.up);
        transform.position += _forward * (_axis * fMoveSpeed * Time.deltaTime);
    }
